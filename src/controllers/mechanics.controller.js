...
// Returns all bookings with status = 'REQUESTED'
// ─────────────────────────────────────────────
const getJobRequests = async (req, res) => {
  try {
    ...
    snapshot.forEach((doc) => {
      const data = doc.data();
      // Include unassigned jobs or jobs dispatched to this mechanic
...
// Returns jobs where mechanic has accepted
// ─────────────────────────────────────────────
...
// Returns: todayEarnings, totalEarnings, completedJobs, rating
// ─────────────────────────────────────────────
